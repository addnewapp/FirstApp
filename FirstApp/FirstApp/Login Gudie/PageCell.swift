...
// construct the page attributes(pagecell) into a page
class PageCell: UICollectionViewCell {
    ...
    var page: Page? {
        didSet {
            ...
            // set the text & its attributes in its text view of the cells (pages) within the UIcollection view
    ...
    func setupViews() {
        ...
        // set the image view & its view position
        imageView.anchorToTop(topAnchor, left: leftAnchor, bottom: textView.topAnchor, right: rightAnchor)
        
        // set the text view & its view position
        textView.anchorWithConstantsToTop(nil, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, topConstant: 0, leftConstant: 16, bottomConstant: 0, rightConstant: 16)
        textView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.3).isActive = true

        // set the line separator view & its view position
